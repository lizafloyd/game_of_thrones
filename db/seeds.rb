...
tyrion = Character.create(first_name: "Tyrion", last_name: "Lannister", alive: true, house_id: 1)
ned = Character.create(first_name: "Eddard", last_name: "Stark", alive: false, house_id: 2)
